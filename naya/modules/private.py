...
async def _owner(client: Client, message: Message): 
    ...
    if message.reply_to_message:
        ...
        if message_id:
            ...
            reply_message = await message.reply_text(f"<b><blockquote>terkirim ke {message_id['user_id']}</b></blockquote>", reply_to_message_id=message.id, disable_notification=True)
        ...
        if last_msg:
            ...
            if message_id:
                ...
                reply_message = await message.reply_text(f"<b><blockquote>terkirim ke {message_id['user_id']}</b></blockquote>", reply_parameters=ReplyParameter(message_id=message_id))
