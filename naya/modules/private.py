...
from pyrogram.types.reply_parameters import ReplyParameters
...
async def _owner(client: Client, message: Message): 
    ...
    if message.reply_to_message:
        ...
        if message_id:
            ...
            await message.reply_text(f"<b><blockquote>terkirim ke {message_id['user_id']}</b></blockquote>",  reply_parameters=ReplyParameter(message_id=message_id, disable_notification=True))
